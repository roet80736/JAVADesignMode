package com.xiciwutong.utils.swagger;
...
public class SwaggerConfig extends WebMvcConfigurerAdapter {
    ...
    //private static final String HOST = "www.xiciwutong.xin";
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.xiciwutong"))
    ...
    private ApiInfo apiInfo() {
        ...
        ApiInfo apiInfo = new ApiInfo("DesignMode系统", "API文档", "V1.0.0", "", contact, "DesignMode系统", "http://www.xiciwutong.xin/", new ArrayList<>());
        return apiInfo;
    }
